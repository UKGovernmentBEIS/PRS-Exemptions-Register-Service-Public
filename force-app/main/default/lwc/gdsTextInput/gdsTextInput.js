...
export default class GdsTextInput extends LightningElement {
    ...
    @track hasMatchingError = false;
    
    @api h1Size = false;
    @api h2Size = false;
    @api h3Size = false;

    @api valueToValidateAgainst;
    @api valueToValidateAgainstErrorMessage;
    ...
    handleValidate() {
        ...
        if (this.required && this.value === '') {
            ...
            errorMessageToShow = this.errorMessage;
        } else {
            ...
            if(this.valueToValidateAgainst !== undefined && this.valueToValidateAgainst !== '') {
                if(this.value !== this.valueToValidateAgainst) {
                    this.hasErrors = true;
                    this.hasMatchingError = true;

                    if(this.valueToValidateAgainstErrorMessage !== undefined && this.valueToValidateAgainstErrorMessage !== '') {
                        errorMessageToShow = this.valueToValidateAgainstErrorMessage;
                    }
                }
            }
        }
